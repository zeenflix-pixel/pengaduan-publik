...
<div class="card">
    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
        ...
        <a href="/petugas/pengaduan" class="btn btn-outline-primary btn-sm">Lihat Semua</a>
    </div>
            ...
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="/petugas/pengaduan/{{ $p->id_pengaduan }}" class="btn btn-outline-primary btn-sm">Tanggapi</a></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
